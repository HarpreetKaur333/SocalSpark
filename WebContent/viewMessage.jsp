    ...
    <div id="wrapper">
        ...
        <div class="main_content">
            ...
            <div class="container m-auto pt-5">
                ...
                <h1 class="font-semibold lg:mb-6 mb-3 text-2xl">View Messages</h1>

                <div class="lg:flex lg:shadow lg:bg-white lg:space-y-0 space-y-8 rounded-md lg:-mx-0 -mx-5 overflow-hidden lg:dark:bg-gray-800" style="height: auto;">
                    <div class="lg:w-4/12 bg-white border-r overflow-hidden dark:bg-gray-800 dark:border-gray-600">
						<p style="text-align: center;
							    ...
							    color: #f87171;
							    text-transform: capitalize;">You Send  Message</p>
                    </div>
                    <div class="lg:w-8/12 bg-white dark:bg-gray-800">
                        ...
                        <div class="px-5 py-4 flex uk-flex-between">                                          
                         <h3 class="lg:w-60 mx-auto text-sm uk-heading-line uk-text-center lg:pt-2"><span><%= (new java.util.Date()).toLocaleString()%></span></h3>
                          ...
                          <tag:forEach var="msglist" items="${messagelist}"> 
                          		<div style="margin-left:15px;"><i class="fa fa-envelope" aria-hidden="true" style="display:inline;margin-right:6px;"></i><p style="display: contents;">${msglist.getMessage()}</p></div>                               
                              	<input type="hidden" value="" name="frndid">	
                          </tag:forEach>       
                ...
                <div class="lg:flex lg:shadow lg:bg-white lg:space-y-0 space-y-8 rounded-md lg:-mx-0 -mx-5 overflow-hidden lg:dark:bg-gray-800" style="height: auto;">
                    <div class="lg:w-4/12 bg-white border-r overflow-hidden dark:bg-gray-800 dark:border-gray-600">
						<p style="text-align: center;
							    ...
							    text-decoration: double;
							    color: #f87171;
							    text-transform: capitalize;">You Received Message From your Friends</p>
                    </div>
                    <div class="lg:w-8/12 bg-white dark:bg-gray-800">
                        ...
                        <div class="px-5 py-4 flex uk-flex-between">                                          
                         <h3 class="lg:w-60 mx-auto text-sm uk-heading-line uk-text-center lg:pt-2"><span><%= (new java.util.Date()).toLocaleString()%></span></h3>
                          ...
                          <tag:forEach var="getfrndmsglist" items="${GetFrndMessagelist}"> 
                          		<div style="margin-left:15px;"><i class="fa fa-envelope" aria-hidden="true" style="display:inline;margin-right:6px;"></i><p style="display: contents;">${getfrndmsglist.getMessage()}</p></div>                               
                              	<input type="hidden" value="" name="frndid">	
                          </tag:forEach>       
